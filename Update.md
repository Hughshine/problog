...
- Benchmark and plotting tooling: profiling.py runs side_channel_benchmarks across knowledge modes; plotting.py and Plots/ add log-scale per-phase and total time/memory charts; profiling.json and profiling.txt updated.
- Benchmark corpus churn: side_channel_benchmarks and scripts were added (flattened dataset) and later removed in 7dd3241 as cleanup; many of these large inputs/outputs are effectively redundant artifacts.
